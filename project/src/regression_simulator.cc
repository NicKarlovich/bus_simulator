 ...
 */
#include "src/regression_simulator.h"
...
bool RegressionSimulator::Start() {
  ...
  // CC Eastbound stops
  Stop * stop_CC_EB_1 = new Stop(3, 44.976397, -93.221801);  // before transit
...
bool RegressionSimulator::Update() {
  // increase time
